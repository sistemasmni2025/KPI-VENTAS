              ...
              {Array.from({ length: daysInMonth }).map((_, i) => {
                ...
                return (
                  <button
                    ...
                    className={`w-7 h-7 rounded-full text-xs flex items-center justify-center transition-colors mx-auto cursor-pointer ${
                      isSelected 
    ...
    return (
      <div className="relative">
        <button
          ...
          className={`flex items-center space-x-2 px-5 py-2.5 rounded-full border text-sm font-medium transition-all duration-300 backdrop-blur-md cursor-pointer ${
            !isToday || isActive
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-sm transition-all duration-200 cursor-pointer ${
                        isSelected ? 'bg-indigo-50 text-indigo-800 font-bold' : 'hover:bg-rose-50 hover:text-rose-700 text-slate-800 font-semibold'
                      }`}
                    >
                      <span>{optName}</span>
